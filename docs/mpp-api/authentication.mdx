...
Tier 2 means an agent has one identity across every Remlo employer who authorizes them, and reputation accrues to the on-chain agentId across every system that reads ERC-8004 — not just Remlo.
